...
echo "Use this commit message so release-please adds a serialization note to the changelog:"
echo "  feat(serialization): bump SILO serialization version to $NEW_VERSION"
