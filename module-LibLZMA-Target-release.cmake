...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET LibLZMA::LibLZMA
                 ...
                 $<$<CONFIG:Release>:${xz_utils_LINKER_FLAGS_RELEASE}>)
    set_property(TARGET LibLZMA::LibLZMA
                 APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${xz_utils_INCLUDE_DIRS_RELEASE}>)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET LibLZMA::LibLZMA
                 APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${xz_utils_LIB_DIRS_RELEASE}>)
    set_property(TARGET LibLZMA::LibLZMA
                 APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${xz_utils_COMPILE_DEFINITIONS_RELEASE}>)
    set_property(TARGET LibLZMA::LibLZMA
                 APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${xz_utils_COMPILE_OPTIONS_RELEASE}>)
