...
echo "=== Building and uploading rhydb to PyPI ==="
...
WHEEL=$(ls -t dist/rhydb-*.whl 2>/dev/null | head -n 1)
...
echo "  pip install --index-url https://test.pypi.org/simple/ --extra-index-url https://pypi.org/simple/ rhydb"
