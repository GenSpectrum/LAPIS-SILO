...
class BidirectionalStringMap {
  ...
  public:
   ...
   BidirectionalStringMap(BidirectionalStringMap&& map) = default;
   BidirectionalStringMap& operator=(BidirectionalStringMap&& map) = default;
   ...
   BidirectionalStringMap(const BidirectionalStringMap& map) = delete;
   BidirectionalStringMap& operator=(const BidirectionalStringMap& map) = delete;
