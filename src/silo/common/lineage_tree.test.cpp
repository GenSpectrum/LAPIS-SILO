...
TEST(LineageTree, correctLeastCommonAncestorOfRecombinantSimple) {
   ...
   ASSERT_EQ(LineageTree::computeRecombinantCladeAncestors({{1}, {}, {1}, {2, 0}}), correct_lca);
}

TEST(LineageTree, correctAncestorsInRecombinantGraph) {
   auto lineage_tree = LineageTree::fromEdgeList(4, {{1, 2}, {2, 3}, {1, 0}, {0, 3}}, {}, {});
...
TEST(LineageTree, correctLeastCommonAncestorOfRecombinantComplex) {
   ...
   ASSERT_EQ(
      LineageTree::computeRecombinantCladeAncestors({{1}, {}, {1}, {2, 0}, {3, 5}, {0}}),
      correct_lca
   );
}

TEST(LineageTree, correctAncestorsInRecombinantGraphComplex) {
   auto lineage_tree = LineageTree::fromEdgeList(
