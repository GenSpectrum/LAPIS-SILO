...
TEST(String, correctNullStringInequality) {
   const SiloString under_test("");

   EXPECT_TRUE(under_test != SiloString::makeNullString());
   EXPECT_FALSE(under_test == SiloString::makeNullString());
}

TEST(String, correctNullStringEquality) {
   const SiloString under_test = SiloString::makeNullString();

   EXPECT_TRUE(under_test == SiloString::makeNullString());
   EXPECT_FALSE(under_test == SiloString{""});
}
