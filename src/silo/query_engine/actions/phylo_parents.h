...
class PhyloParents : public TreeAction {
  public:
   PhyloParents(std::string column_name, bool print_nodes_not_in_tree);
   ...
   std::string_view getType() const override { return "PhyloParents"; }

   std::string_view myResultFieldName() const override { return "parentNodes"; }
};
