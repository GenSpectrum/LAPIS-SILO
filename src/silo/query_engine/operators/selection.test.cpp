...
TEST(OperatorSelection, equalsShouldReturnCorrectValues) {
   const std::vector<int64_t> test_column({{0, 1, 4, 4, 4, 1, 1, 1, 1, 1}});
   const uint32_t row_count = 13;

   const Selection<int64_t> under_test(
      test_column, Selection<int64_t>::Comparator::EQUALS, 1, row_count
   );
...
TEST(OperatorSelection, notEqualsShouldReturnCorrectValues) {
   ...
   const Selection<int64_t> under_test(
      test_column, Selection<int64_t>::Comparator::NOT_EQUALS, 1, row_count
   );
...
TEST(OperatorSelection, lessShouldReturnCorrectValues) {
   ...
   const Selection<int64_t> under_test(
      test_column, Selection<int64_t>::Comparator::LESS, 1, row_count
   );
...
TEST(OperatorSelection, lessOrEqualsShouldReturnCorrectValues) {
   ...
   const Selection<int64_t> under_test(
      test_column, Selection<int64_t>::Comparator::LESS_OR_EQUALS, 1, row_count
   );
...
TEST(OperatorSelection, higherOrEqualsShouldReturnCorrectValues) {
   ...
   const Selection<int64_t> under_test(
      test_column, Selection<int64_t>::Comparator::HIGHER_OR_EQUALS, 1, row_count
   );
...
TEST(OperatorSelection, higherShouldReturnCorrectValues) {
   ...
   const Selection<int64_t> under_test(
      test_column, Selection<int64_t>::Comparator::HIGHER, 1, row_count
   );
