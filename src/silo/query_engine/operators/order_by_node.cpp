...
arrow::Result<arrow::acero::ExecNode*> removeRandomizeColumn(
   silo::query_engine::operators::PartialArrowPlan plan
) {
...
arrow::Result<arrow::acero::ExecNode*> addSortNode(
   ...
   auto schema = silo::query_engine::exec_node::columnsToArrowSchema(output_fields);
...
std::string_view OrderByNode::getType() const {
   return "OrderByNode";
}
...
arrow::Result<PartialArrowPlan> OrderByNode::toQueryPlan(
   ...
   const auto null_placement = first_sort_key.order == arrow::compute::SortOrder::Ascending
                                  ...
                                  : NullPlacement::AtEnd;
   arrow::Ordering ordering{sort_keys, null_placement};
