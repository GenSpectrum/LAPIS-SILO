...
template <>
std::map<std::string, column::StringColumn>& ColumnGroup::getColumns<
   column::StringColumn>() {
   return string_columns;
}

template <>
std::map<std::string, column::IntColumn>& ColumnGroup::getColumns<
   column::IntColumn>() {
   return int_columns;
}

template <>
std::map<std::string, column::BoolColumn>& ColumnGroup::getColumns<
   column::BoolColumn>() {
   return bool_columns;
}

template <>
std::map<std::string, column::FloatColumn>& ColumnGroup::getColumns<
   column::FloatColumn>() {
   return float_columns;
}

template <>
std::map<std::string, column::Date32Column>& ColumnGroup::getColumns<
   column::Date32Column>() {
   return date32_columns;
}

template <>
std::map<std::string, column::SequenceColumn<Nucleotide>>& ColumnGroup::
   getColumns<column::SequenceColumn<Nucleotide>>() {
   return nuc_columns;
}
...
template <>
std::map<std::string, column::ZstdCompressedStringColumn>& ColumnGroup::
   getColumns<column::ZstdCompressedStringColumn>() {
...
template <>
const std::map<std::string, column::StringColumn>& ColumnGroup::getColumns<
   column::StringColumn>() const {
   return string_columns;
}

template <>
const std::map<std::string, column::IntColumn>& ColumnGroup::getColumns<
   column::IntColumn>() const {
   return int_columns;
}

template <>
const std::map<std::string, column::BoolColumn>& ColumnGroup::getColumns<
   column::BoolColumn>() const {
   return bool_columns;
}

template <>
const std::map<std::string, column::FloatColumn>& ColumnGroup::getColumns<
   column::FloatColumn>() const {
   return float_columns;
}

template <>
const std::map<std::string, column::Date32Column>& ColumnGroup::getColumns<
   column::Date32Column>() const {
   return date32_columns;
}

template <>
const std::map<std::string, column::SequenceColumn<Nucleotide>>& ColumnGroup::
   getColumns<column::SequenceColumn<Nucleotide>>() const {
   return nuc_columns;
}

template <>
const std::map<std::string, column::SequenceColumn<AminoAcid>>& ColumnGroup::
   getColumns<column::SequenceColumn<AminoAcid>>() const {
   return aa_columns;
}

template <>
const std::map<std::string, column::ZstdCompressedStringColumn>& ColumnGroup::
   getColumns<column::ZstdCompressedStringColumn>() const {
   return zstd_compressed_string_columns;
}
...
std::expected<void, std::string> insertToSequenceColumn(
   ...
   auto& sequence_column =
      columns.getColumns<column::SequenceColumn<SymbolType>>().at(column.name);
   bool is_null;
...
std::expected<void, std::string> ColumnValueInserter::operator()<column::Date32Column>(
   ...
   if (is_null) {
      ...
      return columns.getColumns<column::Date32Column>()
         .at(column.name)
         .insert(column_value);
   }
   return {};
