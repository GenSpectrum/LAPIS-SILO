...
TEST_F(HorizontalCoverageIndexTest, ConstructsWithValidGenomeLength) {
   EXPECT_NO_THROW({ HorizontalCoverageIndex index; });
}

TEST_F(HorizontalCoverageIndexTest, ConstructsWithZeroLength) {
   EXPECT_NO_THROW({ HorizontalCoverageIndex index; });
}

// Null Sequence Tests
TEST_F(HorizontalCoverageIndexTest, InsertSingleNullSequence) {
   EXPECT_NO_THROW(index->insertNullSequence());
}
...
TEST_F(HorizontalCoverageIndexTest, InsertSingleSequenceAtOffsetZero) {
   ...
   EXPECT_NO_THROW(index->template insertSequenceCoverage<Nucleotide>(sequence, 0));
}

TEST_F(HorizontalCoverageIndexTest, InsertSequenceWithOffset) {
   std::string sequence = "ACGT";
   EXPECT_NO_THROW(index->template insertSequenceCoverage<Nucleotide>(sequence, 10));
}
...
TEST_F(HorizontalCoverageIndexTest, InsertMultipleSequences) {
   EXPECT_NO_THROW({
      index->template insertSequenceCoverage<Nucleotide>("ACGT", 0);
      index->template insertSequenceCoverage<Nucleotide>("TGCA", 5);
      index->template insertSequenceCoverage<Nucleotide>("AAAA", 10);
   });
}

// Bitmap Retrieval Tests - Covered Positions
TEST_F(HorizontalCoverageIndexTest, SequenceNotInBitmapForCoveredPositions) {
   index->template insertSequenceCoverage<Nucleotide>("ACGT", 0);  // Covers positions 0-3
...
TEST_F(HorizontalCoverageIndexTest, MultipleSequencesWithOverlap) {
   index->template insertSequenceCoverage<Nucleotide>("ACGTACGT", 0);  // Sequence 0 covers 0-7
   index->template insertSequenceCoverage<Nucleotide>("TGCA", 5);      // Sequence 1 covers 5-8
   index->template insertSequenceCoverage<Nucleotide>("AAAA", 10);     // Sequence 2 covers 10-13
...
TEST_F(HorizontalCoverageIndexTest, NonOverlappingSequences) {
   index->template insertSequenceCoverage<Nucleotide>("ACGT", 0);   // Covers 0-3
   index->template insertSequenceCoverage<Nucleotide>("TGCA", 10);  // Covers 10-13
...
TEST_F(HorizontalCoverageIndexTest, SequenceWithNIsUncoveredAtNPosition) {
   index->template insertSequenceCoverage<Nucleotide>("ACNGT", 0);  // Position 2 has N
...
TEST_F(HorizontalCoverageIndexTest, SequenceWithMultipleNs) {
   index->template insertSequenceCoverage<Nucleotide>("ANNNGTA", 0);  // Positions 1, 2, 3 have N
...
TEST_F(HorizontalCoverageIndexTest, SequenceWithAllNs) {
   index->template insertSequenceCoverage<Nucleotide>("NNNN", 5);
...
TEST_F(HorizontalCoverageIndexTest, MultipleSequencesWithNAtSamePosition) {
   index->template insertSequenceCoverage<Nucleotide>("ACNGT", 0);  // N at position 2
   index->template insertSequenceCoverage<Nucleotide>("AANAT", 0);  // N at position 2
   index->template insertSequenceCoverage<Nucleotide>("ACGGT", 0);  // No N (G at position 2)
...
TEST_F(HorizontalCoverageIndexTest, SequenceWithNAndOffset) {
   index->template insertSequenceCoverage<Nucleotide>("ACNGT", 10);  // N at position 12
...
TEST_F(HorizontalCoverageIndexTest, SequenceWithMixedCase) {
   index->template insertSequenceCoverage<Nucleotide>("AcGt", 0);
   EXPECT_NO_THROW(index->template insertSequenceCoverage<Nucleotide>("AcGt", 0));
}

TEST_F(HorizontalCoverageIndexTest, SequenceWithLowercaseN) {
   index->template insertSequenceCoverage<Nucleotide>("ACnGT", 0);  // lowercase n at position 2
...
TEST_F(HorizontalCoverageIndexTest, InsertSequenceAtEndOfGenome) {
   index->template insertSequenceCoverage<Nucleotide>("ACG", GENOME_LENGTH - 3);
...
TEST_F(HorizontalCoverageIndexTest, InsertSequenceWithNAtEndOfGenome) {
   index->template insertSequenceCoverage<Nucleotide>("ACN", GENOME_LENGTH - 3);
...
TEST_F(HorizontalCoverageIndexTest, InsertSequenceExtendingBeyondGenome) {
   ...
   EXPECT_NO_THROW(index->template insertSequenceCoverage<Nucleotide>("ACGTACGT", GENOME_LENGTH - 2)
   );
}

// Mixed Null and Non-Null Sequences
TEST_F(HorizontalCoverageIndexTest, MixedNullAndCoveredSequences) {
   index->template insertSequenceCoverage<Nucleotide>("ACGT", 0);  // Sequence 0: covers 0-3
   index->insertNullSequence();  // Sequence 1: null (uncovered everywhere)
   index->template insertSequenceCoverage<Nucleotide>("TGCA", 0);  // Sequence 2: covers 0-3
...
TEST_F(HorizontalCoverageIndexTest, MultipleNullsWithCoverage) {
   ...
   index->template insertSequenceCoverage<Nucleotide>("ACGT", 5);  // Sequence 2: covers 5-8
...
TEST_F(HorizontalCoverageIndexTest, MixedNullCoverageAndNCharacters) {
   index->template insertSequenceCoverage<Nucleotide>("ACNGT", 0);  // Sequence 0: N at position 2
   index->insertNullSequence();                                     // Sequence 1: null everywhere
   index->template insertSequenceCoverage<Nucleotide>("ACGGT", 0);  // Sequence 2: fully covered 0-4
...
TEST_F(HorizontalCoverageIndexTest, CompletelyOverlappingSequences) {
   index->template insertSequenceCoverage<Nucleotide>("AAAA", 5);
   index->template insertSequenceCoverage<Nucleotide>("TTTT", 5);
   index->template insertSequenceCoverage<Nucleotide>("GGGG", 5);
...
TEST_F(HorizontalCoverageIndexTest, OverlappingSequencesWithN) {
   index->template insertSequenceCoverage<Nucleotide>("ANNN", 5);  // Only position 5 covered
   index->template insertSequenceCoverage<Nucleotide>("NANN", 5);  // Only position 6 covered
   index->template insertSequenceCoverage<Nucleotide>("NNAN", 5);  // Only position 7 covered
...
TEST_F(HorizontalCoverageIndexTest, PartiallyOverlappingSequences) {
   index->template insertSequenceCoverage<Nucleotide>("AAAAAAAA", 0);  // 0-7
   index->template insertSequenceCoverage<Nucleotide>("TTTTTTTT", 4);  // 4-11
   index->template insertSequenceCoverage<Nucleotide>("GGGGGGGG", 8);  // 8-15
...
TEST_F(HorizontalCoverageIndexTest, AdjacentNonOverlappingSequences) {
   index->template insertSequenceCoverage<Nucleotide>("AAAA", 0);  // 0-3
   index->template insertSequenceCoverage<Nucleotide>("TTTT", 4);  // 4-7
   index->template insertSequenceCoverage<Nucleotide>("GGGG", 8);  // 8-11
...
TEST_F(HorizontalCoverageIndexTest, ManySequencesAtDifferentPositions) {
   ...
   for (size_t i = 0; i < NUM_SEQUENCES; ++i) {
      index->template insertSequenceCoverage<Nucleotide>(
         "A", i
      );  // Each sequence covers one position
   }
...
TEST_F(HorizontalCoverageIndexTest, LongSequence) {
   ...
   index->template insertSequenceCoverage<Nucleotide>(long_sequence, 0);
...
TEST_F(HorizontalCoverageIndexTest, InsertSequencesInOrder) {
   index->template insertSequenceCoverage<Nucleotide>("A", 0);
   index->template insertSequenceCoverage<Nucleotide>("T", 0);
   index->template insertSequenceCoverage<Nucleotide>("G", 0);
...
TEST_F(HorizontalCoverageIndexTest, EmptySequenceIsAlwaysUncovered) {
   index->template insertSequenceCoverage<Nucleotide>("", 5);
