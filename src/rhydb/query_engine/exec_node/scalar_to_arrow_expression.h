...
/// (resolved when the expression is bound to a schema); `at`, `isoWeek` and zstd-decompress map to
/// the corresponding Arrow compute calls. Returns `NotImplemented` for expressions with no Arrow
/// translation.
